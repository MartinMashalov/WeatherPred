...
| 5 Structural search | Local bias, nowcasting, both latency types, dispersion, tails, bracket/cross-market consistency, temporal/maker/regime tests | E013/E014 ran 1,836 trading-policy/cost comparisons. None qualifies. E015/E016 now test paired makers and netting; E018 selects 12 conditional hourly models on August data and registers new forward paper execution. E019 now tests a registered daily/weekend precipitation relation with independent leg fills; observation-reaction and broader relative value remain open |
