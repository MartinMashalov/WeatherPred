...
| 5 Structural search | Local bias, nowcasting, both latency types, dispersion, tails, bracket/cross-market consistency, temporal/maker/regime tests | E013/E014 ran1,836trading-policy/cost comparisons. None qualifies; observation-reaction, maker economics and broader relative-value research remain open |
...
| 13 Forward | Immutable before-outcome decisions and hypothetical fills; settled shadow outcomes and promotion gates | E009 has64taker and22maker fill records across32alternative accounts/one underlying event at14:26UTC; cash/fees/raw execution replayed. Paper settlements and sufficient independent days pending; two earlier original forecast events finalized |
